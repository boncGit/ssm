...
/**
 * Created by wangqiang on 2017/4/21.
 */
public class OracleGenerator {
    ...
    public static void main(String[] args) {
        ...
        strategy.setInclude(new String[]{"E_USER"}); // 需要生成的表
        ...
        pc.setParent("com.watchme.api");// 自定义包路径
        ...
        // 打印注入设置
        System.err.println(mpg.getCfg().getMap().get("abc") + "over.....");
    }
}
