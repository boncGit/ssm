...
import com.watchme.common.exception.BusinessException;
import com.watchme.common.exception.ErrorCode;
...
public class ResponseResultUtil {
	...
	public static ResponseResult getErrorResult(String errorMessage, Object data) {
		return buildResult(ResponseResult.ERROR, errorMessage, data);
	}
	...
	private static ResponseResult buildResult(String code, String message, Object data) {
		ResponseResult rs = new ResponseResult(false);
		rs.setStatus(code);
