...
public class SnowflakeIdWorker {
    ...
    public SnowflakeIdWorker() {
        this.dataCenterId = getDataCenterId(MAX_ID);
        this.workerId = getMaxWorkerId(dataCenterId, MAX_DATA_CENTER_ID);
    }
    ...
    public SnowflakeIdWorker(long workerId, long dataCenterId) {
        ...
        System.out.println(String.format("worker starting. timestamp left shift %d, datacenter id bits %d, worker id bits %d, sequence bits %d, workerid %d", TIMESTAMP_LEFT_SHIFT_BITS, DATA_CENTER_ID_BITS, ID_BITS, SEQUENCE_BITS, workerId));
    }
    ...
    public synchronized long nextId() {
        ...
        if (timestamp < lastTimestamp) {
            System.err.println(String.format("clock is moving backwards.  Rejecting requests until %d.", lastTimestamp));
