var ECharts = { 
    ...
    ChartConfig: function (container, option) {
        var chart_path = rootPath+"/static/metronic/global/plugins/echarts"; //配置图表请求路径
        //var map_path = "../echarts-map"; //配置地图的请求路径
    ...
    ChartDataFormate: {
        FormateNOGroupData: function (data) {
            ...
            for (var i = 0; i < data.length; i++) {
                ...
                //datas[i]={'name':data['name'],'value':data['value']};
                datas.push({ name: data[i].name, value: data[i].value  });
