...
(function(mod) {
  ...
  CodeMirror.defineMode("django:inner", function() {
    ...
    // the delimeter). Mark everything as a string util the start delimeter
    // occurs again.
    ...
    function inTag (stream, state) {
      ...
      if (stream.match("%}")) {
        ...
        // following code as comment, util the tag closes.
    ...
    // Mark everything as a comment util the `blockcomment` tag closes.
