...
<script src="${rootPath}/static/metronic/global/plugins/bootstrap-toastr/toastr.min.js" ></script>
<link href="${rootPath}/static/metronic/global/plugins/bootstrap-toastr/toastr.min.css"  rel="stylesheet" type="text/css"/>
